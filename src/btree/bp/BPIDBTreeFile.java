...
import global.BPID;
import utils.supplier.btfilescan.BPIDBTFileScanSupplier;
import utils.supplier.btfilescan.BTFileScanSupplier;
import utils.supplier.btheaderpage.BPIDBTreeHeaderPageSupplier;
 ...
 */
public abstract class BPIDBTreeFile<K> extends BTreeFileI<BPID, BasicPattern,K> {
	@Override
	public BTreeHeaderPageSupplier<BPID, BasicPattern> getBTreeHeaderPageSupplier() {
		return BPIDBTreeHeaderPageSupplier.getSupplier();
	}
	
	@Override
	public BTSortedPageSupplier<BPID, BasicPattern> getBTSortedPageSupplier() {
		return BPIDBTSortedPageSupplier.getSupplier();
	}
	
	@Override
	public BTIndexPageSupplier<BPID, BasicPattern> getBTIndexPageSupplier() {
		return BPIDBTIndexPageSupplier.getSupplier();
	}
	
	@Override
	public BTLeafPageSupplier<BPID, BasicPattern> getBTLeafPageSupplier() {
		return BPIDBTLeafPageSupplier.getSupplier();
	}
	...
	@Override
	public BTFileScanSupplier<BPID, BasicPattern,K> getBTFileScanSupplier() {
		return new BPIDBTFileScanSupplier<K>();
	}
   ...
   *          of this btree file.
   */
  public BPIDBTreeHeaderPage getHeaderPage() {
    return (BPIDBTreeHeaderPage) super.getHeaderPage();
  }
...
//
   ...
   */
  public BPIDBTreeFile(String filename) throws GetFileEntryException,PinPageException,ConstructPageException
    {
      super(filename);
    }
   ...
   */
  public BPIDBTreeFile(String filename, int keytype,
...
//
   ...
   */
  public void insert(KeyClass key, BPID rid)
...
//  private KeyDataEntry  _insert(KeyClass key, BPID rid,
...
//    }
   ...
   *
   */
  public boolean Delete(KeyClass key, BPID rid)
...
//
  ...
  /*
   *  Status BTreeFile::NaiveDelete (const void *key, const BPID rid)
   *
...
//  private boolean NaiveDelete ( KeyClass key, BPID rid)
...
//    }
  ...
  /*
   * Status BTreeFile::FullDelete (const void *key, const BPID rid)
   * 
   * Remove specified data entry (<key, rid>) from an index.
   *
...
//  private boolean FullDelete (KeyClass key,  BPID rid)
...
//    }
   ...
   *@exception UnpinPageException error when unpin a page
   */
  public BPIDBTFileScan new_scan(KeyClass lo_key, KeyClass hi_key)
    throws IOException,  
	   KeyNotMatchException, 
	   IteratorException, 
	   ConstructPageException, 
    ...
    {
      return (BPIDBTFileScan) super.new_scan(lo_key, hi_key);
    }
