 ...
 */
public class QIDBTIndexPage extends BTIndexPageI<QID, Quadruple>{
   ...
   */
  public QIDBTIndexPage(PageId pageno, int keyType)
    throws IOException,
   ...
   *@exception ConstructPageException error when BTIndexpage constructor
   */
  public QIDBTIndexPage(Page page, int keyType)
    throws IOException,
	   ConstructPageException
    {
      super(page, keyType);
   ...
   *@exception ConstructPageException error when BTIndexpage constructor
   */
  public QIDBTIndexPage(int keyType)
    throws IOException, 
	   ConstructPageException
    {
      super(keyType);
   ...
   */
  protected QID deleteKey(KeyClass key)
   ...
   */
  protected boolean redistribute(QIDBTIndexPage indexPage, QIDBTIndexPage parentIndexPage,
