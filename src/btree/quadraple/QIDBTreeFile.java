...
public abstract class QIDBTreeFile<K> extends BTreeFileI<QID, Quadruple,K> {
	...
	@Override
	public BTSortedPageSupplier<QID, Quadruple> getBTSortedPageSupplier() {
		return QIDBTSortedPageSupplier.getSupplier();
	}
	
	@Override
	public BTIndexPageSupplier<QID, Quadruple> getBTIndexPageSupplier() {
		return QIDBTIndexPageSupplier.getSupplier();
	}
	
	@Override
	public BTLeafPageSupplier<QID, Quadruple> getBTLeafPageSupplier() {
   ...
   *          of this btree file.
   */
  public QIDBTreeHeaderPage getHeaderPage() {
    return (QIDBTreeHeaderPage) super.getHeaderPage();
  }
...
//
   ...
   */
  public QIDBTreeFile(String filename)
    throws GetFileEntryException,
	   PinPageException,
   ...
   */
  public QIDBTreeFile(String filename, int keytype,
...
//    }
   ...
   *@exception UnpinPageException error when unpin a page
   */
  public QIDBTFileScan new_scan(KeyClass lo_key, KeyClass hi_key)
    throws IOException,  
	   KeyNotMatchException, 
	   IteratorException, 
	   ConstructPageException, 
    ...
    {
      return (QIDBTFileScan) super.new_scan(lo_key, hi_key);
    }
