 ...
 */
public class LIDBTIndexPage extends BTIndexPageI<LID, Label>{
   ...
   */
  public LIDBTIndexPage(PageId pageno, int keyType)
    throws IOException,
   ...
   *@exception ConstructPageException error when BTIndexpage constructor
   */
  public LIDBTIndexPage(Page page, int keyType)
    throws IOException,
	   ConstructPageException
    {
      super(page, keyType);
   ...
   *@exception ConstructPageException error when BTIndexpage constructor
   */
  public LIDBTIndexPage(int keyType)
    throws IOException, 
	   ConstructPageException
    {
      super(keyType);
   ...
   */
  protected LID deleteKey(KeyClass key)
   ...
   */
  protected boolean redistribute(LIDBTIndexPage indexPage, LIDBTIndexPage parentIndexPage,
