 ...
 */
public class BPIDBTreeFile extends BTreeFileI<BPID, BasicPattern> {
	@Override
	...
	public IDSupplier<BPID> getIDSupplier() {
		return BPIDupplier.getSupplier();
	}
	...
	@Override
	public BTFileScanSupplier<BPID, BasicPattern> getBTFileScanSupplier() {
		return BPIDBTFileScanSupplier.getSupplier();
	}
...
//
   ...
   */
  public BPIDBTreeFile(String filename)
    throws GetFileEntryException,
	   PinPageException,
...
//
  ...
  /*
   *  Status BTreeFile::NaiveDelete (const void *key, const QID rid)
   * 
...
//    }
  ...
  /*
   * Status BTreeFile::FullDelete (const void *key, const QID rid)
   * 
   * Remove specified data entry (<key, rid>) from an index.
   *
