...
public class BTreeFile extends BTreeFileI<RID, Tuple> {
	...
	@Override
	public BTSortedPageSupplier<RID, Tuple> getBTSortedPageSupplier() {
		return RIDBTSortedPageSupplier.getSupplier();
	}
	
	@Override
	public BTIndexPageSupplier<RID, Tuple> getBTIndexPageSupplier() {
		return RIDBTIndexPageSupplier.getSupplier();
	}
	
	@Override
	public BTLeafPageSupplier<RID, Tuple> getBTLeafPageSupplier() {
  ...
  public BTreeHeaderPage getHeaderPage() {
    return (BTreeHeaderPage) super.getHeaderPage();
  }
...
//    }
  ...
  public BTFileScan new_scan(KeyClass lo_key, KeyClass hi_key)
    ...
    {
      return (BTFileScan) super.new_scan(lo_key, hi_key);
    }
