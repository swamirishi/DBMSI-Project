...
public class LabelHeapFile implements Filetype, GlobalConst {
    ...
    */
    private boolean  _findDataPage( LID qid,
        ...
        {// Start While01
                 ...
                 currentDataPageRid = currentDirPage.nextRecord(currentDataPageRid))
            {
                ...
                if(dpinfo.pageId.pid==qid.pageNo.pid)
                {
                    ...
                    rpDataPageQid.pageNo.pid = currentDataPageRid.pageNo.pid;
                    rpDataPageQid.slotNo = currentDataPageRid.slotNo;
                    return true;
                }
                else
                {
...

    {
        ...
        while(currentDirPageId.pid != INVALID_PAGE)
        {
            ...
            {
                atuple = currentDirPage.getRecord(qid);
                DataPageInfo dpinfo = new DataPageInfo(atuple);
            ...
            IOException
    {
        ...
        { //Start While01
            ...
            { //Start IF01
                ...
                if(currentDirPage.available_space() >= dpinfo.size)
                {
                    ...
                    LID tmpqid = currentDirPage.firstRecord();
        ...
        LID qid;
        qid = currentDataPage.insertRecord(recPtr);
     ...
     */
    public boolean deleteRecord(LID qid)
            throws InvalidSlotNumberException,
            InvalidTupleSizeException,
            HFException,
            HFBufMgrException,
     ...
     */
    public boolean updateRecord(LID qid, Label newtuple)
            throws InvalidSlotNumberException,
            ...
            Exception
    {
        ...
        if(status != true) return status;	// record not found
        Label atuple = new Label();
        atuple = dataPage.returnRecord(qid);
     ...
     */
    public  Label getRecord(LID qid)
            throws InvalidSlotNumberException,
            InvalidTupleSizeException,
            HFException,
            HFDiskMgrException,
