...
public class QuadrupleUtilsTest {
    ...
    public static void main(String[] args) throws FieldNumberOutOfBoundException, IOException, UnknowAttrType, QuadrupleUtilsException, HFDiskMgrException, HFException, HFBufMgrException {
        init();
        if(QuadrupleUtilsTest.checkQuadrupleCompare()) System.out.println("TEST 1 status: PASSED");
    }

    private static boolean checkQuadrupleCompare() throws UnknowAttrType, FieldNumberOutOfBoundException, QuadrupleUtilsException, HFDiskMgrException, HFException, HFBufMgrException, IOException {
