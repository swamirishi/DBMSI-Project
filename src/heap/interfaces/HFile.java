    ...
    */
            ...
            Exception
    {
        ...
        {// Start While01
            ...
            for( currentDataPageRid = (I)currentDirPage.firstRecord();
                 currentDataPageRid != null;
                 currentDataPageRid = (I)currentDirPage.nextRecord(currentDataPageRid))
            {
                try{
                ...
                if(dpinfo.pageId.pid==rid.getPageNo().pid)
                {
                    atuple = (T) currentDataPage.returnRecord(rid);
                    ...
                    rpDataPageRid.getPageNo().pid = currentDataPageRid.getPageNo().pid;
                    rpDataPageRid.setSlotNo(currentDataPageRid.getSlotNo());
                    return true;
                }
                else
                {
     ...
     */
    public I insertRecord(byte[] recPtr)
            throws InvalidSlotNumberException,
            InvalidTupleSizeException,
            ...
            IOException
    {
        ...
        { //Start While01
            ...
            { //Start IF01
                ...
                if(currentDirPage.available_space() >= dpinfo.size)
                {
                    ...
                    atuple = (T) dpinfo.convertToTuple();
                    
                    byte [] tmpData = atuple.getTupleByteArray();
                    currentDataPageRid = (I) currentDirPage.insertRecord(tmpData);
                    
                    I tmprid = (I) currentDirPage.firstRecord();
        ...
        I rid;
        rid = (I) currentDataPage.insertRecord(recPtr);
     ...
     */
    public boolean deleteRecord(I rid)
            throws InvalidSlotNumberException,
            InvalidTupleSizeException,
            HFException,
            HFBufMgrException,
    ...
    
    {
        ...
        else
        {
            ...
            currentDataPageRid = (I) currentDirPage.firstRecord();
     ...
     */
    public boolean updateRecord(I rid, T newtuple)
            throws InvalidSlotNumberException,
