...
public abstract class HFilePage<T extends ID,E extends Tuple> extends Page
  ...
  */
  ...
  protected abstract E getTuple(byte[] record, int offset, int length);
  /**
   ...
   */
  public T insertRecord ( byte [] record)
    throws IOException
    {
        T rid = this.getID();
   ...
   */
  public void deleteRecord ( T rid )
    throws IOException,  
  ...
  public E getRecord ( T rid ) throws IOException, InvalidSlotNumberException {
	  ...
	  && (pageNo.pid == curPage.pid))
	{
	  ...
	  E tuple = this.getTuple(record,0,recLen);
	  return tuple;
	}
  ...
  public E returnRecord ( T rid ) throws IOException, InvalidSlotNumberException, InvalidTupleSizeException {
	  ...
	  && (pageNo.pid == curPage.pid))
	{
	  ...
	  offset = getSlotOffset (slotNo);
	  E tuple  = getTuple(data,offset,recLen);
	  return tuple;
	}
