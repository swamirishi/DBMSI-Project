 ...
 */
public abstract class pnodePQI<T extends Tuple> {
    /**
     ...
     */
    abstract public void enq(pnodeI<T> item) throws IOException, UnknowAttrType, TupleUtilsException;
     ...
     * @throws TupleUtilsException error in tuple compare routines
     */
    public boolean pnodeEQ(pnodeI<T> a, pnodeI<T> b) throws IOException, UnknowAttrType, TupleUtilsException {
