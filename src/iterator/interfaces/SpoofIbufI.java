...
public abstract class SpoofIbufI<I extends ID, T extends Tuple> implements GlobalConst {
     ...
     */
    public void init(HFile<I, T> fd, byte bufs[][], int n_pages, int tSize, int Ntuples) throws IOException, Exception {
        _fd = fd;
        _bufs = bufs;
        _n_pages = n_pages;
        t_size = tSize;
